...
if (isAdmin($logged_user)) {
    echo "                    <div class=\"form-group\">\n                      <label class=\"form-control-label\">Destinário</label>\n                      <div class=\"input-group\">\n                        <span class=\"input-group-addon\"><i class=\"fa fa-user\"></i></span>\n                          <select class=\"form-control\" name=\"reseller\" required=\"\" autocomplete=\"off\">\n                            <option value=\"\"></option>\n                            ";
    ...
    echo "                          </select>\n                      </div>\n                      <span class=\"text-help\">Escolha o revendedor que você deseja enviar a mensagem</span>\n                    </div>\n                  ";
}
echo "                    <div class=\"form-group\">\n                      <label class=\"form-control-label\">Titulo do Ticket</label>\n                      <input type=\"text\" class=\"form-control\" required=\"\" placeholder=\"Titulo\" autocomplete=\"off\" name=\"title\" data-minlength=\"6\" minlength=\"6\">\n                      <span class=\"text-help\">Minimo 6 caracteres</span>\n                    </div>\n                    <div class=\"form-group\">\n                      <label class=\"form-control-label\">Mensagem</label>\n                      <textarea class=\"form-control\" placeholder=\"Adicione informações relevantes\" name=\"message\" data-maxlength=\"1000\" maxlength=\"1000\"></textarea>\n                      <span class=\"text-help\">Minimo 6 caracteres</span>\n                    </div>\n                    <div class=\"form-group\">\n                      <button type=\"submit\" class=\"btn btn-success\">Criar Ticket</button>\n                    </div>\n                  </form>\n                </div>\n              </div>\n            </div>\n            <!-- /.box-body -->\n          </div>\n        </section>\n      </div>\n      <!-- /.box -->\n    </section>\n    <!-- /.content -->\n  </div>\n  <!-- /.content-wrapper -->\n  <footer class=\"main-footer\">\n    <div class=\"row\">\n      <div class=\"text-left col-md-6\">\n        <strong>Copyright &copy; ";
echo date("Y");
echo " <a href=\"#\">";
echo $server_name;
