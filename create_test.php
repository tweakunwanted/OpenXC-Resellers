...
echo "          <div class=\"box\">\n            <div class=\"box-body\">\n              <div class=\"row\">\n                <div class=\"col-md-6\">\n                  <form autocomplete=\"off\" action=\"#\" method=\"post\" name=\"frm1\">\n                    <input type=\"hidden\" name=\"action\" value=\"create_custom_test\">\n                    <div class=\"row\">\n                      <div class=\"form-group col-md-12\">\n                        <label class=\"form-control-label\">Duração do Teste</label>\n                        <div>\n                          <label class=\"radio-inline\" style=\"padding-left: 0;\"><input type=\"radio\" name=\"duration\" class=\"flat-red\" value=\"1\" checked> ";
echo $test_time;
...
echo "                          </select>\n                        </div>\n                      </div>\n                    </div>\n                    <div class=\"form-group\">\n                      <button type=\"submit\" class=\"btn btn-success\">Criar Teste</button>\n                    </div>\n                  </form>\n                </div>\n              </div>\n            </div>\n            <!-- /.box-body -->\n          </div>\n        </section>\n      </div>\n      <!-- /.box -->\n    </section>\n    <!-- /.content -->\n  </div>\n  <!-- /.content-wrapper -->\n  <footer class=\"main-footer\">\n    <div class=\"row\">\n      <div class=\"text-left col-md-6\">\n        <strong>Copyright &copy; ";
echo date("Y");
echo " <a href=\"#\">";
echo $server_name;
